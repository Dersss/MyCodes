 ...
 */
public final class GameController1 implements GameController {
     ...
     */
    private static void updateViewToMatchModel(GameModel model,
            GameView view) {
     ...
     *            view to connect to
     */
    public GameController1(GameModel model, GameView view) {
        this.model = model;
        this.view = view;
