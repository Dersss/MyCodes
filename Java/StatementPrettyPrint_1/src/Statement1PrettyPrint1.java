    ...
    public void prettyPrint(SimpleWriter out, int offset) {
        ...
        switch (this.kind()) {
            ...
            case IF: {
                ...
                Statement hold = this.newInstance();
                Condition cond = this.disassembleIf(hold);
                printSpaces(out, offset);
                out.println("IF " + toStringCondition(cond) + " THEN");
                hold.prettyPrint(out, offset + indent);
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIf(cond, hold);
            ...
            case IF_ELSE: {
                ...
                Condition ifElseCondition = this.disassembleIfElse(subIf,
                        subElse);
                printSpaces(out, offset);
                out.println(
                ...
                printSpaces(out, offset);
                out.println("END IF");
                this.assembleIfElse(ifElseCondition, subIf, subElse);
            ...
            case WHILE: {
                ...
                // TODO - fill in case
                Statement hold = this.newInstance();
                Condition whileCondition = this.disassembleWhile(hold);
                printSpaces(out, offset);
                out.println(
                ...
                this.assembleWhile(whileCondition, hold);
                break;
            }
            case CALL: {
