...
public abstract class StackTest {
    ...
    private Stack<String> createFromArgsTest(String... args) {
        ...
        Stack<String> fromArg = this.constructorTest();
        int pos = args.length - 1;
        while (pos >= 0) {
            fromArg.push(args[pos]);
            pos--;
        }
    ...
    private Stack<String> createFromArgsRef(String... args) {
        ...
        // TODO - fill in body
        Stack<String> fromArg = this.constructorRef();
        String[] argsHold = args;
        int pos = args.length - 1;
        while (pos >= 0) {
            fromArg.push(argsHold[pos]);
            pos--;
        }
    ...
    @Test
    public final void testPopLeavingOne() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "blue");
    ...
    @Test
    public final void testPopLeavingTwo() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "white", "blue");
        Stack<String> sExpected = this.createFromArgsRef("white", "blue");
        /*
         * Call method under test
         */
        String x = s.pop();
    ...
    @Test
    public final void testPopPoppingTwo() {
        /*
         * Set up variables
         */
        Stack<String> s = this.createFromArgsTest("red", "white", "blue");
