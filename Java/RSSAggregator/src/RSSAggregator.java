...
/**
 * Program to convert multiple XML RSS (version 2.0) feeds from a list of
 * given URL into the corresponding HTML output files.
 *
 *
...
public final class RSSAggregator {
    ...
    private static void outputHeader(XMLTree channel, SimpleWriter out) {
        ...
        if (description == -1) {
            out.println(
                    "<h3 style =\"color:red;\" >" + "No Description" + "</h3>");
        } else {
            out.println("<h3 style=\"color:red;\" >"
                    + channel.child(description) + "</h3>");
        }
    ...
    public static void main(String[] args) {
        ...
        out.println("Name of file containing feeds: ");
        String url = in.nextLine();
        out.println("Name of file to write too: ");
        ...
        fileOut.println("<h1>" + orig.attributeValue("title") + "</h1>");
        fileOut.println("</head>");

        fileOut.println("<body>");

        int numChild = orig.numberOfChildren();
        int i = 0;
        while (i < numChild) {
            if (orig.child(i).label().equals("feed")) {
                String file = orig.child(i).attributeValue("file");
                String name = orig.child(i).attributeValue("name");
                String url2 = orig.child(i).attributeValue("url");
                fileOut.println(
                        "<li><a href=\"" + file + "\">" + name + "</a></li>");
                processFeed(url2, file, out);
            }
            i++;
        }
        fileOut.println("</body>");
