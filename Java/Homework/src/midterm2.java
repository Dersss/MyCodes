...
public final class midterm2 {
    ...
    public static void main(String[] args) {
        ...
        NaturalNumber con1 = new NaturalNumber2(1234567);
        out.println("con1 before: " + con1);
        int dig1 = 4;
        boolean found = containsDigit(con1, dig1);
        out.println("con1 after: " + con1);
        if (found) {
            out.println("Found");
        }
        /*
