...
public abstract class StatementTest {
    ...
    private static final String FILE_NAME_2 = "data/emptyBlock.bl";
    private static final String FILE_NAME_3 = "data/blockSize1.bl";
    ...
    /**
     * Test lengthOfBlock of an empty block.
     */
    @Test
    ...
    /**
     * Test removeFromBlock leaving a empty block behind.
     */
    @Test
    ...
    /**
     * Test addToBlock of an empty block.
     */
    @Test
    public final void testAddToEmptyBlock() {
        /*
         * Setup
         */
        Statement sTest = this.createFromFileTest(FILE_NAME_2);
        Statement sRef = this.createFromFileRef(FILE_NAME_2);
        Statement tmpRef = this.createFromFileRef(FILE_NAME_1);
        Statement tmpTest = this.createFromFileTest(FILE_NAME_1);
        Statement emptyBlock = tmpRef.newInstance();
        Statement addToBlockRef = tmpRef.removeFromBlock(1);
        Statement addToBlockTest = tmpTest.removeFromBlock(1);
        sRef.addToBlock(0, addToBlockRef);

        /*
         * The call
         */
        sTest.addToBlock(0, addToBlockTest);

        /*
         * Evaluation
         */
        assertEquals(emptyBlock, addToBlockTest);
        assertEquals(sRef, sTest);
    }

    /**
     * Test addToBlock to front.
     */
    @Test
     ...
     */
    @Test
    public final void testBlockWhile() {
        /*
         * Setup
         */
        Statement sourceTest = this.createFromFileTest(FILE_NAME_1);
